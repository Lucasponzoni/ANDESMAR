            ...
            snapshot.forEach(fechaSnap => {
                fechaSnap.forEach(camionSnap => {
                    camionSnap.forEach(envioSnap => {
                        ...
                        if (tipoBusqueda === 'sku' && (
                            (typeof info.producto1 === 'string' && info.producto1.toLowerCase().includes(valorBusqueda.toLowerCase())) ||
                            (typeof info.producto2 === 'string' && info.producto2.toLowerCase().includes(valorBusqueda.toLowerCase())) ||
                            (typeof info.producto3 === 'string' && info.producto3.toLowerCase().includes(valorBusqueda.toLowerCase()))
                        )) {
                            match = true;
                        }
